package com.example.sky.jetpackCompose.image
...
fun LazyListScope.displayImagesComponent() {
    ...
    item {
        ...
        LocalResourceImageComponent(R.drawable.mindorks_cover)
    }
    ...
    item {
        TitleComponent("Images with rounded corners")
        ImageWithRoundedCorners(R.drawable.mindorks_cover)
    }
}
...
fun LocalResourceImageComponent(@DrawableRes resId: Int) {
    ...
    // Images composable to have a height of 200 dp.
    Image(
        painter = image,
