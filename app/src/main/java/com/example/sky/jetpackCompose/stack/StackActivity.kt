package com.example.sky.jetpackCompose.stack
...
import com.example.sky.jetpackCompose.image.LocalResourceImageComponent
...
fun StackComponent() {
    ...
    Box(modifier = Modifier.fillMaxWidth().height(200.dp)) {
        ...
        LocalResourceImageComponent(resId = 0)
