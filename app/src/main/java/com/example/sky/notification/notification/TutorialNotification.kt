...
//            .setSmallIcon(R.drawable.ic_notifications)
            ...
            .setLargeIcon(
                ResourcesCompat.getDrawable(context.resources,/* R.drawable.ic_image*/ 0, context.theme)?.toBitmap()
            )
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            builder.setStyle(
                NotificationCompat.BigPictureStyle()
                    .bigPicture(Icon.createWithResource(context,/* R.drawable.ic_image*/ 0))
                    .bigLargeIcon(null)
            )
        }
